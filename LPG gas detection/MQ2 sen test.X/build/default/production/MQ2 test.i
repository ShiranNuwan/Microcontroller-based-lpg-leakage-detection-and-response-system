...
__attribute__((picinterrupt(("")))) void timer_isr(void){
    if( TMR0IF == 1){
        TMR0IF = 0 ;
        currentMillis ++ ;
        }
...
void initializer(){
    ...
    RD1 = 1 ; _delay((unsigned long)((50)*(16000000/4000.0))) ; RD1 = 0 ; _delay((unsigned long)((50)*(16000000/4000.0))) ;
    RD1 = 1 ; _delay((unsigned long)((50)*(16000000/4000.0))) ; RD1 = 0 ;
    _delay((unsigned long)((50)*(16000000/4000.0))) ;
    Lcd_Clear() ;
    }
